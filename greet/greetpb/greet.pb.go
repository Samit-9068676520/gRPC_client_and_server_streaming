...
func (x *GreetRespnse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetRespnse) ProtoMessage() {}

func (x *GreetRespnse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetRespnse.ProtoReflect.Descriptor instead.
func (*GreetRespnse) Descriptor() ([]byte, []int) {
	return file_greet_proto_rawDescGZIP(), []int{2}
}

func (x *GreetRespnse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_proto_rawDesc = []byte{
	...
	0x08, 0x67, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x26, 0x0a, 0x0c, 0x47, 0x72, 0x65,
	0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73,
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xda, 0x01, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65,
	0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x33, 0x0a, 0x05, 0x47, 0x72, 0x65, 0x65,
	...
	0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x51, 0x0a,
...
var file_greet_proto_goTypes = []interface{}{
	...
	(*GreetRespnse)(nil),           // 2: greet.GreetRespnse
...
var file_greet_proto_depIdxs = []int32{
	...
	2, // 6: greet.GreetService.Greet:output_type -> greet.GreetRespnse
